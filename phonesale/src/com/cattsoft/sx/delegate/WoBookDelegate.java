...
public class WoBookDelegate {
	private static Logger log = Logger.getLogger(SoManagerDelegate.class);

	private static WoBookDelegate delegateInstance = null;
	private WoBookDelegate() {

	}
	public static WoBookDelegate getDelegate() {
		if (delegateInstance == null)
			return new WoBookDelegate();
...
//			String urlStr = SysConstants.SYS_CONFIG_MOS_SERVER_ADDR;
			...
			String mosLoginRep = client.workBook(paramStr);
			return mosLoginRep;
