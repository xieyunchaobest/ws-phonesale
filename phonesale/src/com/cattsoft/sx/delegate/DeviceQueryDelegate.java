...
public class DeviceQueryDelegate {

	private static Logger log = Logger.getLogger(SoManagerDelegate.class);

	private static DeviceQueryDelegate delegateInstance = null;

	private DeviceQueryDelegate() {

	}
	public static DeviceQueryDelegate getDelegate() {
		if (delegateInstance == null)
			return new DeviceQueryDelegate();
