...
public class OtherCharacteristicMVO extends GenericVO {
	
    private static final long serialVersionUID = 1L;

    private String characteristicId;

    private String otherCharacteristicId;
    ...
    public String getOtherCharacteristicId() {
        return otherCharacteristicId;
    }

    public void setOtherCharacteristicId(String otherCharacteristicId) {
        this.otherCharacteristicId = otherCharacteristicId;
    }
}