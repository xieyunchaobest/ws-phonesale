...
public class PartyHistSVO extends GenericVO {
	...
	public void setPartyHistId(String partyHistId) {
		this.partyHistId = partyHistId;
	}

	public String getPartyHistId() {
		return partyHistId;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj != null && obj instanceof PartyHistSVO) {
			PartyHistSVO another = (PartyHistSVO) obj;
			equals = new EqualsBuilder().append(partyId, another.getPartyId())
					.append(seq, another.getSeq()).append(partyHistId,
							another.getPartyHistId()).isEquals();
		}
		return equals;
	}

	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(partyId).append(seq).append(
				partyHistId).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("partyId", getPartyId())
				.append("seq", getSeq())
				.append("partyHistId", getPartyHistId()).toString();
	}
}