...
{
	Demos[0] = document.getElementById('statcol');
	Demos[4] = document.getElementById('list');
	Demos[9] = document.getElementById('rowlist');

	if  (Demos[0])
	{
		CreateDragContainer(document.getElementById('select_statcolumn'), document.getElementById('show_column'));
	}
	if  (Demos[4])
	{
		CreateDragContainer(document.getElementById('select_column'), document.getElementById('select_rowhead'), document.getElementById('select_colhead'));
	}
	if (Demos[9])
	{
		CreateDragContainer(document.getElementById('select_column'), document.getElementById('select_rowhead'));
	}
